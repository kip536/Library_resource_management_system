...
import psycopg2
from instructor_dashboard import *
from ins_otp import *
...
class instructorlogin:
    def __init__ (self, window):
        ...
        self.window.title("Instructor Login Form")
        ...
        self.heading = Label(self.window, text=self.txt, font=('yu gothic ui', 30, "bold"), bg="white",
                                ...
                                bd=5,
                                relief=FLAT)
        self.heading.place(x=550, y=70, width=300)
        ...
        self.forgot_button = Button(self.window, text="Forgot Password ?",
                                    ...
                                    , borderwidth=0, background="white", cursor="hand2", command=self.forgotpasswrd)
    ...
    def validation(self):
        ...
        try:
            ...
            query = "SELECT passwrd from employeetable WHERE username = '"+username+"';"
            cur.execute(query)
            con.commit()
            data = cur.fetchone()
            print(data)
    ...
    def login_success(self):
        global page2
        newwindow = Toplevel()
        page2 = instructordashboard(newwindow)
        page2 = Clock(newwindow)



    def forgotpasswrd(self):
        self.window.withdraw()
        global page2
        newwindow = Toplevel()
